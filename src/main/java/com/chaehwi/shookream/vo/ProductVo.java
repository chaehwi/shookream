package com.chaehwi.shookream.vo;
...
public String toString() {
	return "ProductBean [product_idx=" + product_idx + ", product_name=" + product_name + ", product_brand="
			...
			+ product_img2 + ", product_img3=" + product_img3 + ", product_date=" + product_date
			+ ", product_wishcount=" + product_wishcount + ", cart_idx=" + cart_idx + ", member_idx=" + member_idx
			+ ", wish_idx=" + wish_idx + "]";
}
